...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/backend/img/brand/logo.png') }}" class="main-logo" alt="logo"></a>
        <a class="desktop-logo logo-dark active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/backend/img/brand/logo-white.png') }}" class="main-logo dark-theme"
                alt="logo"></a>
        <a class="logo-icon mobile-logo icon-light active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/backend/img/brand/favicon.png') }}" class="logo-icon" alt="logo"></a>
        <a class="logo-icon mobile-logo icon-dark active" href="{{ url('/' . ($page = 'index')) }}"><img
                src="{{ URL::asset('assets/backend/img/brand/favicon-white.png') }}" class="logo-icon dark-theme"
                alt="logo"></a>
    </div>
    <div class="main-sidemenu">
            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    <img alt="user-img" class="avatar avatar-xl brround"
                        src="{{ URL::asset('assets/backend/img/faces/6.jpg') }}"><span
        ...
        <ul class="side-menu">
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'index')) }}"></span><i
                        class="icon ion-ios-home side-menu__icon"></i><span class="side-menu__label">Home</a>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><i
                        class="icon ion-ios-settings side-menu__icon"></i><span class="side-menu__label">General
                        Settings</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li><a class="slide-item" href="#">Company Settings</a></li>
                    <li><a class="slide-item" href="#">Site Settings</a></li>
                    <li><a class="slide-item" href="{{ route('admin.users') }}">Users</a></li>
                    <li><a class="slide-item" href="{{ route('admin.billing-categories') }}">billing-categories</a></li>
                    <li><a class="slide-item" href="{{ route('admin.product') }}">product</a></li>
                    <li><a class="slide-item" href="{{ route('admin.product-categories') }}">product-categories</a></li>
                    <li><a class="slide-item" href="{{ route('admin.rols') }}">Roles And permissions</a></li>
                    <li><a class="slide-item" href="{{ route('admin.safe') }}">safes</a></li>
                    <li><a class="slide-item" href="{{ route('admin.tag') }}">tags</a></li>
                </ul>
            </li>
            <li class="slide">
